...
import presedents from "../assets/Amb.-Siam.jpg";
        ...
        <div className={`grid md:grid-cols-10 gap-8 w-full`}>
          <div className={`w-full md:col-span-2`}>
            ...
            <div className={`mt-4`}>
              ...
              <h4 className={`text-center`}>Ambassador</h4>
              <p className={`text-center text-sm text-[#8D8D92]`}>
                Embassy of the People's Republic of <br /> Bangladesh <br />
                Manila, Philippines
              </p>
            </div>
          </div>
