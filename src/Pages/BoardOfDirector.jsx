...
import AdvisoryBoardMember from "../assets/advisory-board-member.jpg";
  ...
  return (
    <div className="relative">
      ...
      <div className="container px-4 mx-auto mb-20 lg:px-48">
        ...
        <div>
          <h1 className="text-center text-green-600 lg:text-4xl md:text-3xl sm:text-xl">
            ADVISORY BOARD
          </h1>
          <div className="w-24 h-1 mx-auto mt-2 mb-5 bg-green-700 advisory-board-divider"></div>
